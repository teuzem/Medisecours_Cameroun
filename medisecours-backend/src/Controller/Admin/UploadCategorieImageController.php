...
class UploadCategorieImageController extends AbstractController
{
    #[Route('/{id}/images', name: 'admin_upload_categorie_images', methods: ['POST'])]
    public function uploadImages(Categorie $categorie, Request $request, EntityManagerInterface $em): JsonResponse
    {
        try {
    ...
    #[Route('/{id}/images/{imageId}', name: 'admin_delete_categorie_image', methods: ['DELETE'])]
    public function deleteImage(Categorie $categorie, int $imageId, EntityManagerInterface $em): JsonResponse
    {
