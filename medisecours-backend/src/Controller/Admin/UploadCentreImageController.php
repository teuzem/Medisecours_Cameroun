...
class UploadCentreImageController extends AbstractController
{
    #[Route('/{id}/images', name: 'admin_upload_centre_images', methods: ['POST'])]
    public function uploadImages(CentreDeSante $centre, Request $request, EntityManagerInterface $em): JsonResponse
    {
        try {
    ...
    #[Route('/{id}/images/{imageId}', name: 'admin_delete_centre_image', methods: ['DELETE'])]
    public function deleteImage(CentreDeSante $centre, int $imageId, EntityManagerInterface $em): JsonResponse
    {
