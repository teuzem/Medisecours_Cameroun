...
export function ImportMaladiesModal({ isOpen, onClose, onSuccess }: { isOpen: boolean; onClose: () => void; onSuccess: () => void }) {
    ...
    const downloadTemplate = async () => {
        try {
            const response = await api.get('/api/admin/import/maladies/template');
            const data = response.data;
